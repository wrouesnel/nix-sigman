...
// extracted from https://github.com/NixOS/nixpkgs/pkgs/build-support/fetchurl/mirrors.nix
// At some point we should probably switch to dynamically downloading it.
var mirrorSubstitutions = map[string][]string{
